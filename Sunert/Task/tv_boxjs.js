/* 
本脚本为电视节目预告，配合chavyleung大佬的boxjs使用
1.数据从电视家数据库获取
2.常用卫视代码
...
Surge 4.0 :  
[Script]
tvpreview.js = type=cron,cronexp=35 5 0 * * *,script-path=https://raw.githubusercontent.com/Sunert/Scripts/master/Task/tv_boxjs.js,script-update-interval=0

～～～～～～～～～～～～～～～～～
Loon 2.1.0+
[Script]
# 本地脚本
cron "04 00 * * *" script-path=https://raw.githubusercontent.com/Sunert/Scripts/master/Task/tv_boxjs.js, enabled=true, tag=电视节目预告
